...
//         NormalBalance: '',
//       };
//   // Update account code whenever any of the dependencies change
//   useEffect(() => {
//     if (
//       values.AccountTypeID ||
//       values.AccountSubTypeID ||
...
//       const newAccountCode = `${accountGroupCode}-${majorAccountGroupCode}-${subMajorAccountGroupCode}-${accountSuffix}`;
//       setFieldValue('AccountCode', newAccountCode);
//     }
//   }, [
//     values.AccountTypeID,
...
//             value={values.AccountCode}
//             onChange={(e) => {
//               // Extract the suffix when user manually changes the account code
//               const parts = e.target.value.split('-');
//               if (parts.length > 3) {
//                 setAccountSuffix(parts.slice(3).join('-'));
//               }
//               handleChange(e);
//             }}
//             onBlur={handleBlur}
...
//             readOnly // Make it read-only if you want to prevent manual editing
//           />
